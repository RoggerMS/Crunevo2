...
def upgrade():
    ...
    op.create_table('personal_block',
    ...
    op.create_index(op.f('ix_personal_block_user_id'), 'personal_block', ['user_id'], unique=False)
    op.create_index(op.f('ix_personal_block_block_type'), 'personal_block', ['block_type'], unique=False)
    op.create_index(op.f('ix_personal_block_order_position'), 'personal_block', ['order_position'], unique=False)
