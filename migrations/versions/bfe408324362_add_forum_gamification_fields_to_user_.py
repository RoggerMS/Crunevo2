...
def upgrade():
    ...
    # Add forum gamification fields to user table
    op.add_column(
        "user", sa.Column("forum_level", sa.Integer(), nullable=True, default=1)
    )
    op.add_column(
        "user", sa.Column("forum_experience", sa.Integer(), nullable=True, default=0)
    )
    op.add_column(
        "user", sa.Column("forum_streak", sa.Integer(), nullable=True, default=0)
    )
    op.add_column("user", sa.Column("last_activity_date", sa.Date(), nullable=True))
    op.add_column(
        "user", sa.Column("questions_asked", sa.Integer(), nullable=True, default=0)
    )
    op.add_column(
        "user", sa.Column("answers_given", sa.Integer(), nullable=True, default=0)
    )
    op.add_column(
        "user", sa.Column("best_answers", sa.Integer(), nullable=True, default=0)
    )
    op.add_column(
        "user", sa.Column("helpful_votes", sa.Integer(), nullable=True, default=0)
    )
    op.add_column(
        "user", sa.Column("reputation_score", sa.Integer(), nullable=True, default=0)
    )
    op.add_column(
        "user", sa.Column("custom_forum_title", sa.String(length=50), nullable=True)
    )
