...
def upgrade():
    ...
    sa.Column('item_type', sa.Enum('apunte', 'post', 'logro', 'evento', 'movimiento', 'mensaje', name='feed_item_type'), nullable=False),
    ...
    with op.batch_alter_table('feed_item', schema=None) as batch_op:
        batch_op.create_index('idx_feed_type_ref', ['item_type', 'ref_id'], unique=False)
