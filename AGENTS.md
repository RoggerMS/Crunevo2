...
- Fixed club_modernization migration referencing missing revision; updated down_revision and added merge migration with system_error_log to unify heads (PR fix-migration-heads).
