...
def create_sample_mentorships():
    ...
    with app.app_context():
        ...
        try:
            ...
            if not user:
                print("No hay usuarios en la base de datos. Se necesita al menos 1 usuario.")
                return
            mentor_id = user.id
        ...
        try:
            ...
            for mentorship in Mentorship.query.all():
                print(f"- {mentorship.subject_area} (Status: {mentorship.status.value}) - ID: {mentorship.id}")
