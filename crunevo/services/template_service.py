...
class TemplateService:
    ...
    @staticmethod
    def create_template(
        user_id: int, template_data: Dict[str, Any]
    ...
    def create_template_from_workspace(
        ...
        blocks = (
            PersonalSpaceBlock.query.filter_by(user_id=user_id, status="active")
    ...
    @staticmethod
    def apply_template(
        template_id: str, user_id: int, replace_existing: bool = False
    ...
    def get_template_categories() -> List[Dict[str, Any]]:
        ...
        categories = (
            ...
            .filter(PersonalSpaceTemplate.is_public.is_(True))
            .group_by(PersonalSpaceTemplate.category)
            .all()
        )
    ...
    @staticmethod
    def update_template(
        template_id: str, user_id: int, update_data: Dict[str, Any]
    ) -> PersonalSpaceTemplate:
    ...
    def get_popular_templates(limit: int = 10) -> List[PersonalSpaceTemplate]:
        ...
        return (
            PersonalSpaceTemplate.query.filter_by(is_public=True)
            .order_by(PersonalSpaceTemplate.created_at.desc())
            .limit(limit)
            .all()
        )
    ...
    def search_templates(query: str, user_id: int) -> List[PersonalSpaceTemplate]:
        ...
        return (
            PersonalSpaceTemplate.query.filter(
                and_(
                    or_(
                        PersonalSpaceTemplate.user_id == user_id,
                        PersonalSpaceTemplate.is_public.is_(True),
            ...
            .order_by(PersonalSpaceTemplate.updated_at.desc())
            .all()
        )
