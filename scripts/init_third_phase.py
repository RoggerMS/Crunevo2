...
def init_sample_forum_content():
    ...
    for question_data in questions_data:
        ...
        if not existing:
            ...
            # Add a sample answer
            answer = ForumAnswer(
                content=f"Excelente pregunta. Te recomiendo empezar creando un plan de estudio estructurado y usar la técnica Pomodoro para mantener la concentración. También revisa los apuntes disponibles en CRUNEVO para tu área de estudio.",
